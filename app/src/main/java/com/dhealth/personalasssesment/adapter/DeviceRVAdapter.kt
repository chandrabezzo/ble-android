...
import com.dhealth.personalasssesment.data.model.Device
import kotlinx.android.synthetic.main.item_rv_device.view.*

class DeviceRVAdapter(private val list: MutableList<BluetoothDevice>): RecyclerView.Adapter<DeviceRVAdapter.Item>() {
